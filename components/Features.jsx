  ...
  return (
    <>
      ...
      <section className="relative dark:bg-gray-950 bg-white">
        <div className="relative overflow-hidden dark:bg-gray-950 bg-white pt-16 pb-32 space-y-24">
          {/* First Feature */}
            ...
            <div className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-flow-col-dense lg:grid-cols-2 lg:gap-24 lg:px-8">
              <div className="mx-auto max-w-xl px-6 lg:mx-0 lg:max-w-none lg:py-16 lg:px-0 ">
                <div>
                  ...
                  <div className="mt-6">
                    <h2 className="text-3xl font-semibold tracking-tight dark:text-white text-gray-950">
                      Natural Language Processing (NLP):
                    </h2>
                    <p className="mt-4 text-lg dark:text-white text-gray-950">
                  ...
                  <div>
                    <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-pink-500">
                      <svg
                        ...
                        stroke="currentColor"
                        aria-hidden="true"
                        className="h-8 w-8 dark:text-white text-gray-950"
                      >
                        <path
                          strokeLinecap="round"
                          strokeLinejoin="round"
